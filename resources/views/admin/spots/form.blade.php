...
<div class="form-group">
	<div class="row pb-20">
		<div class="col-sm-12">
			<label>Nombre</label>
			<input type="text"
			       placeholder="El nombre del puesto"
			       class="form-control"
			       name="name"
	...
	<div class="row pb-20">
		<div class="col-sm-12">
			...
			<textarea
			       ...
			       class="form-control"
			       name="description"
			>{{ old('description', $spot->description) }}</textarea>
		...
		<div class="col-sm-12">
			...
			<div class="checkbox checkbox-switchery">
				...
				<input name="active" id="active" type="checkbox" class="switchery" value="1"
					{!! $spot->active || old('active')? 'checked' : null !!}
				/>
		...
		<div class="col-sm-12">
			...
			<div class="checkbox checkbox-switchery">
				...
				<input name="create_resource" id="create_resource" type="checkbox" class="switchery" value="1"
					{!! $spot->isResource() || old('create_resource')? 'checked' : null !!}
				/>
					<span class="text-muted">
