...
<li class="media border-left-primary" data-resourceable-type="{{ $resource->resourceable->type }}">
    ...
    <div class="media-body">
        ...
        <div class="media-right media-middle">
            ...
            <div class="form form-inline @if(!$selectedResource) hidden @endif">
                <div class="form-group">
                    <label for="">Esta disponible para eventos</label>
                    <label for="resources[{{$resource->id}}][settings][eventable]">
                        <input type="checkbox" class="form-control"
                               name="resources[{{$resource->id}}][settings][eventable]"
                               value="1"
                               id="resources[{{$resource->id}}][settings][eventable]"
                               @if($resource->settings('eventable')) checked @endif
                        />
                    </label>
